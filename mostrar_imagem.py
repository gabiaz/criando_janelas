...
msg01 = Label(oppening, text="Ver uma imagem fofinha? ", background="DarkGoldenRod", font=("Arial", 25, "bold"))
msg01.pack(pady=10)

button = Button(oppening, text="sim \n :)", background="DarkGoldenRod", fg="black", font="Arial",command=show)
button.pack(pady=10)

button2 = Button(oppening, text=" fechar ", background="black", fg="white", font="Arial",command=end)
button2.pack()
